  ...
  object panMain: TPanel
    ...
    object gbColors: TcxGroupBox
      ...
      object Label3: TLabel
        ...
        Width = 87
        Height = 13
        Caption = 'Lettere in eccesso'
      end
      object btnColorVowels: TJvColorButton
        Left = 128
        Top = 24
        Width = 121
        Height = 32
      ...
      object btnColorConsonants: TJvColorButton
        Left = 128
        Top = 72
        Width = 121
        Height = 32
      ...
      object btnColorExcess: TJvColorButton
        Left = 128
        Top = 120
        Width = 121
        Height = 32
    ...
    object chkAllowExcess: TCheckBox
      ...
      Width = 257
      Height = 17
      Caption = 'Consenti lettere in eccesso per default'
      TabOrder = 1
    end
    object rgFontSize: TRadioGroup
      ...
      Width = 273
      Height = 105
      Caption = 'Dimensione dei caratteri'
      Items.Strings = (
        'Piccoli'
        'Medi'
        'Grandi')
